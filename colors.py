...
print(f"{Formatting.red_text}Hello World!{Formatting.end}") # print red text
print(f"{Formatting.blue_text}{Formatting.bold_text}Hello World!{Formatting.end}") # print bold blue text
